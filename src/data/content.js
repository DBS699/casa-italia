...
export const I18N = {
  de: {
    ...
    heroIntro: "Seit 1985 vereint der Velo-Club Casa d'Italia in Bern die Liebe zum Radsport und zur italienischen Lebensart. Gemeinsame Ausfahrten, Touren und Freundschaft – die ganze Saison hindurch.",
    ...
    komiteeKicker: 'Komitee', komiteeTitle: 'Wer den Verein lenkt.', komiteeBody: 'Neun ehrenamtliche Köpfe halten den Velo-Club am Laufen – von der Tourenplanung bis zur Festwirtschaft.',
  ...
  fr: {
    ...
    heroIntro: "Depuis 1985, le Vélo-Club Casa d'Italia réunit à Berne l'amour du cyclisme et de l'art de vivre italien. Sorties, tours et amitié – tout au long de la saison.",
    ...
    komiteeKicker: 'Comité', komiteeTitle: 'Celles et ceux qui mènent le club.', komiteeBody: 'Neuf bénévoles font tourner le vélo-club – de la planification des sorties à la buvette.',
  ...
  it: {
    ...
    heroIntro: "Dal 1985 il Velo-Club Casa d'Italia unisce a Berna l'amore per il ciclismo e per lo stile di vita italiano. Uscite, gite e amicizia – per tutta la stagione.",
    ...
    komiteeKicker: 'Comitato', komiteeTitle: 'Chi guida il club.', komiteeBody: 'Nove volontari mandano avanti il velo-club – dalla pianificazione delle uscite alla festa.',
  ...
  en: {
    ...
    heroIntro: "Since 1985, Velo-Club Casa d'Italia has brought together a love of cycling and Italian living in Bern. Group rides, tours and friendship – all season long.",
    ...
    komiteeKicker: 'Committee', komiteeTitle: 'The people who run the club.', komiteeBody: 'Nine volunteers keep the velo-club rolling – from planning tours to running the festivities.',
