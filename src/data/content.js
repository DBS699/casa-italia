...
export const I18N = {
  de: {
    ...
    seasonKicker: 'Saison 2026', seasonTitle: 'Acht Monate unterwegs.',
    seasonBody: 'An den meisten Sonntagen fahren wir in zwei Gruppen – eine sportliche und eine gemütliche. Im Tour-Fenster findest du beide Strecken; manchmal fahren wir alle gemeinsam.',
  ...
  fr: {
    ...
    seasonKicker: 'Saison 2026', seasonTitle: 'Huit mois sur les routes.',
    seasonBody: "La plupart des dimanches, nous roulons en deux groupes – un sportif et un tranquille. Les deux parcours figurent dans chaque sortie ; parfois nous roulons tous ensemble.",
  ...
  it: {
    ...
    seasonKicker: 'Stagione 2026', seasonTitle: 'Otto mesi in viaggio.',
    seasonBody: 'Quasi ogni domenica pedaliamo in due gruppi – uno sportivo e uno tranquillo. Trovi entrambi i percorsi in ogni uscita; a volte usciamo tutti insieme.',
  ...
  en: {
    ...
    seasonKicker: 'Season 2026', seasonTitle: 'Eight months on the road.',
    seasonBody: "On most Sundays we ride in two groups – a sporty one and an easy-going one. Both routes are shown for each ride; sometimes we all ride together.",
