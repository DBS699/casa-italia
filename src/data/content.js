...
export const I18N = {
  de: {
    ...
    stat: [{ n: '1968', l: 'Gegründet' }, { n: 'Bern', l: 'Heimat' }, { n: 'März–Okt', l: 'Saison' }],
  ...
  fr: {
    ...
    stat: [{ n: '1968', l: 'Fondé' }, { n: 'Berne', l: 'Origine' }, { n: 'Mars–Oct', l: 'Saison' }],
  ...
  it: {
    ...
    stat: [{ n: '1968', l: 'Fondato' }, { n: 'Berna', l: 'Casa' }, { n: 'Mar–Ott', l: 'Stagione' }],
  ...
  en: {
    ...
    stat: [{ n: '1968', l: 'Founded' }, { n: 'Bern', l: 'Home' }, { n: 'Mar–Oct', l: 'Season' }],
